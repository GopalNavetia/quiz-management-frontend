...
import { addQuiz } from "../../../api/adminDashboardApi";
...
function AddQuiz() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            alert(error.response?.data || "Failed to add quiz");
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <main className="space-y-4">
            ...
            <section className="max-w-xl rounded-2xl border bg-white p-5 shadow-sm">
                <h2 className="text-lg font-extrabold">Add Quiz</h2>
                <p className="mt-1 text-xs text-gray-400">Create a new quiz</p>
