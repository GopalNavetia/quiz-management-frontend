...
import { addCategory } from "../../../../api/adminDashboardApi";
...
function AddCategory() {
    ...
    return (
        <main className="mx-auto max-w-lg rounded-xl border bg-white p-4 shadow-sm">
            <h1 className="text-lg font-semibold text-slate-900">Add Category</h1>
            <p className="mt-1 text-sm text-slate-500">Create a new quiz category.</p>
